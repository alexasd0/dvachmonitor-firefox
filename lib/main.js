...
background = pageworkers.Page({
	contentScriptFile: [data.url("libs/underscore.js"), data.url("libs/Immutable.js"), data.url("tools.js"), data.url("bg.js")],
...
popup.port.on("to-background", function(data) {
	//MessageSwitch("to-background", data);
	background.port.emit("to-background", data);
});
...
/*function MessageSwitch(destination, data){
	switch (destination){
		case "to-background":
			background.port.emit("to-background", data);
			break;
